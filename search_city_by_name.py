...
class SearchCityByName(QMainWindow):
    def __init__(self, cities_menu):
        ...
        self.__database_cursor.execute(f"USE {self.__database_name}")

        self.__search_bar = QLineEdit()
        self.__search_bar.setPlaceholderText("enter the name of the city")
    ...
    def __search_button_is_clicked(self):
        ...
        self.__database_cursor.execute(f"SELECT id, name FROM city WHERE name = '{text}';")
